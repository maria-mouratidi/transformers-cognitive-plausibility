...
if __name__ == "__main__":
    ...
    embedding_matrix = model.bert.embeddings.weight  # This is a tf.Variable
    ...
    for sentence in sentences:
        tokens, saliency = extract_relative_saliency(model, embedding_matrix, tokenizer, sentence)
        print("Tokens:", tokens)
        print("Saliency:", saliency)
        global_saliency.append(saliency)
