from helpers.utils_ZuCo import * 
...
sbjs_t2_word = [datatransform_t2_word(i) for i in range(2)] 
#sbjs_t2_sent = [datatransform_t2_sent(i) for i in range(2)] 

# show the first couple of rows for subject 1 for task 2
print(sbjs_t2_word[0].head(60))
